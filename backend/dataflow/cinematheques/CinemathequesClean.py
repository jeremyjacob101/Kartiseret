...
class CinemathequesClean(CinemathequesHelpers, BaseDataflow):
    MAIN_TABLE_NAME = "allTheques"
    HELPER_TABLE_NAME = "tableFixes"

    def logic(self):
        self.dedupeAllTheques(self.MAIN_TABLE_NAME)
        ...
        self.dedupeAllTheques(self.MAIN_TABLE_NAME, refresh=False)
