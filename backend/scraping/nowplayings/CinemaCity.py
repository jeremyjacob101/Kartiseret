...
class CinemaCity(BaseCinema):
    ...
    def logic(self):
        ...
        for cinema_block in range(1, self.lenElements("#moviesContainer > div", "row mainThumbWrapper") + 1):
            for film_card in range(1, self.lenElements(f"/html/body/div[4]/div[4]/div[2]/div[1]/div[{cinema_block}]/div") + 1):
                self.english_titles.append(self.element(f"/html/body/div[4]/div[4]/div[2]/div[1]/div[{cinema_block}]/div[{film_card}]/div/div/div[2]/div/p[1]").get_attribute("textContent"))

                rating = self.element(f"/html/body/div[4]/div[4]/div[2]/div[1]/div[{cinema_block}]/div[{film_card}]/div/div/div[2]/div/div[1]/p[4]/span").get_attribute("textContent")
                self.ratings.append(str(rating).strip() if rating else None)

                runtime = self.element(f"/html/body/div[4]/div[4]/div[2]/div[1]/div[{cinema_block}]/div[{film_card}]/div/div/div[2]/div/div[1]/p[2]/span").get_attribute("textContent").strip()
                runtime = re.sub(r"\D", "", runtime)
                self.runtimes.append(int(runtime) if runtime else None)

                hebrew_title = self.element(f"/html/body/div[4]/div[4]/div[2]/div[1]/div[{cinema_block}]/div[{film_card}]/div/div/div[2]/div/h4").get_attribute("textContent")
        ...
        for cinema in range(1, self.lenElements("/html/body/div[4]/div[2]/div/div/div[2]/div/div[1]/dl/dd/ul/li") + 1):
            ...
            self.jsClick(f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[1]/dl/dd/ul/li[{cinema}]/a", 0.15)
            self.jsClick("/html/body/div[4]/div[2]/div/div/div[2]/div/div[2]/dl/dt/a", 0.15)
            for showtype in range(1, self.lenElements("/html/body/div[4]/div[2]/div/div/div[2]/div/div[2]/dl/dd/ul/li") + 1):
                self.screening_type = self.element(f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[2]/dl/dd/ul/li[{showtype}]/a", f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[1]/dl/dd/ul/li[{cinema}]/a").get_attribute("textContent").strip()
                base_showtech = self.element(f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[2]/dl/dd/ul/li[{showtype}]/a", f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[1]/dl/dd/ul/li[{cinema}]/a").get_attribute("textContent").strip()

                self.jsClick(f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[2]/dl/dd/ul/li[{showtype}]/a", 0.15, f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[1]/dl/dd/ul/li[{cinema}]/a")
                self.jsClick("/html/body/div[4]/div[2]/div/div/div[2]/div/div[3]/dl/dt/a", 0.15)
                for film_index in range(1, self.lenElements("/html/body/div[4]/div[2]/div/div/div[2]/div/div[3]/dl/dd/ul/li/div/div[1]/ul/li") + 1):
                    checking_film_name = str(self.element(f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[3]/dl/dd/ul/li/div/div[1]/ul/li[{film_index}]/a", f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[2]/dl/dd/ul/li[{showtype}]/a").get_attribute("textContent"))
                    ...
                    self.jsClick(f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[3]/dl/dd/ul/li/div/div[1]/ul/li[{film_index}]/a", 0.15, f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[2]/dl/dd/ul/li[{showtype}]/a")
                    self.jsClick("/html/body/div[4]/div[2]/div/div/div[2]/div/div[4]/dl/dt/a", 0.15)
                    for day in range(1, self.lenElements("/html/body/div[4]/div[2]/div/div/div[2]/div/div[4]/dl/dd/ul/li") + 1):
                        self.date_of_showing = self.element(f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[4]/dl/dd/ul/li[{day}]/a", f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[3]/dl/dd/ul/li/div/div[1]/ul/li[{film_index}]/a").get_attribute("textContent")
                        self.date_of_showing = datetime.strptime(re.search(r"\d{1,2}/\d{1,2}/\d{4}", self.date_of_showing).group(), "%d/%m/%Y").date().isoformat()

                        self.jsClick(f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[4]/dl/dd/ul/li[{day}]/a", 0.15, f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[3]/dl/dd/ul/li/div/div[1]/ul/li[{film_index}]/a")
                        self.jsClick("/html/body/div[4]/div[2]/div/div/div[2]/div/div[5]/dl/dt/a", 0.15)
                        for time in range(1, self.lenElements("/html/body/div[4]/div[2]/div/div/div[2]/div/div[5]/dl/dd/ul/li") + 1):
                            self.showtime = self.element(f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[5]/dl/dd/ul/li[{time}]/a", f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[4]/dl/dd/ul/li[{day}]/a").get_attribute("textContent")

                            self.jsClick(f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[5]/dl/dd/ul/li[{time}]/a", 0.15, f"/html/body/div[4]/div[2]/div/div/div[2]/div/div[4]/dl/dd/ul/li[{day}]/a")
